<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="taskadd_sub.aspx.cs" Inherits="lecture.taskadd_sub" %>
            ...
            <tr>
                <td>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label5" runat="server" Text="提交密码："></asp:Label>
                                <asp:TextBox ID="tb_pwd" runat="server"></asp:TextBox>
&nbsp;<asp:Label ID="Label6" runat="server" ForeColor="Red" Text="*本页需要输入提交密码才可提交"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="style3">
