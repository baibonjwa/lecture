<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordAdd.aspx.cs" Inherits="lecture.RecordAdd"
...
<body>
    ...
    <div style="text-align: center">
        ...
        <table border="1" cellpadding="0" cellspacing="0" class="MsoNormalTable" width="100%">
            <tr style="mso-yfti-irow: 0; mso-yfti-firstrow: yes; height: 23.5pt">
                <td colspan="2" style="width: 18.02%; border: solid black 1.0pt; mso-border-alt: solid black .5pt;
                    ...
                    <p align="center" class="MsoNormal">
                        <span style="font-size: 9.0pt; line-height: 150%; font-family: 宋体; mso-ascii-font-family: Calibri;
                            mso-hansi-font-family: Calibri">周次<asp:Label ID="Label3" runat="server" Text="**"
                    ...
                    <p align="center" class="MsoNormal">
                        <span style="font-size: 9.0pt; line-height: 150%; font-family: 宋体; mso-ascii-font-family: Calibri;
                            mso-hansi-font-family: Calibri">日期</span><span lang="EN-US" style="font-size: 9.0pt;
                                line-height: 150%"><o:p></o:p><asp:Label ID="Label5" runat="server" Font-Size="Small"
                ...
                <td colspan="3" style="width: 18.86%; border: solid black 1.0pt; border-left: none;
                    ...
                    <p align="center" class="MsoNormal">
                        <span style="font-size: 9.0pt; line-height: 150%; font-family: 宋体; mso-ascii-font-family: Calibri;
                            mso-hansi-font-family: Calibri">时间</span><asp:Label ID="Label6" runat="server" Font-Size="Small"
                                ForeColor="Red" Text="**"></asp:Label>
                    </p>
                </td>
            ...
            <tr style="mso-yfti-irow: 1; height: 22.8pt">
                <td colspan="2" style="width: 18.02%; border: solid black 1.0pt; border-top: none;
                    ...
                    <p align="center" class="MsoNormal">
                        <span style="font-size: 9.0pt; line-height: 150%; font-family: 宋体; mso-ascii-font-family: Calibri;
                            mso-hansi-font-family: Calibri">地点</span><span lang="EN-US"><o:p></o:p><asp:Label
                ...
                <td style="width: 14.8%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p align="center" class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:TextBox ID="tb_place" runat="server" Width="80px"></asp:TextBox>室</p>
                </td>
                <td style="width: 13.02%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p align="center" class="MsoNormal">
                        <span style="font-size: 9.0pt; line-height: 150%; font-family: 宋体; mso-ascii-font-family: Calibri;
                            mso-hansi-font-family: Calibri">专业班级</span><o:p></o:p></p>
                </td>
                <td colspan="3" style="width: 14.82%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <span lang="EN-US">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:ListBox ID="listbox_MajorClass" runat="server" Height="57px" CssClass="style3"
                    ...
                    <br />
                    <asp:Label ID="lb_classInfo" runat="server" Visible="False"></asp:Label>
                </td>
            ...
            <tr style="mso-yfti-irow: 7; height: 22.8pt">
                ...
                <td colspan="3" style="border-bottom: solid black 1.0pt; border-right: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:TextBox ID="tb_interact" runat="server" TextMode="MultiLine"></asp:TextBox></span><span
                                lang="EN-US"><o:p></o:p></span></p>
                </td>
                ...
                <td style="width: 13.28%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:TextBox ID="tb_ClassHealth" runat="server" TextMode="MultiLine"></asp:TextBox></span><span
                                lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 8; height: 22.8pt">
                ...
                <td style="width: 13.28%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:TextBox ID="tb_ClassChair" runat="server" TextMode="MultiLine"></asp:TextBox></span><span
                                lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 9; height: 22.8pt">
                ...
                <td colspan="3" style="border-bottom: solid black 1.0pt; border-right: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:TextBox ID="tb_ClassNote" runat="server" TextMode="MultiLine"></asp:TextBox></span><span
                                lang="EN-US"><o:p></o:p></span></p>
                </td>
                <td colspan="2" style="width: 17.86%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    border-right: solid black 1.0pt; mso-border-top-alt: solid black .5pt; mso-border-left-alt: solid black .5pt;
                ...
                <td style="width: 13.28%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:TextBox ID="tb_projector" runat="server" TextMode="MultiLine"></asp:TextBox></span><span
                                lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 10; height: 22.8pt">
                ...
                <td colspan="3" style="border-bottom: solid black 1.0pt; border-right: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:TextBox ID="tb_books" runat="server" TextMode="MultiLine"></asp:TextBox></span><span
                                lang="EN-US"><o:p></o:p></span></p>
                </td>
                <td colspan="2" style="width: 17.86%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    border-right: solid black 1.0pt; mso-border-top-alt: solid black .5pt; mso-border-left-alt: solid black .5pt;
                ...
                <td style="width: 13.28%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:TextBox ID="tb_sound" runat="server" TextMode="MultiLine"></asp:TextBox></span><span
                                lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 11; height: 22.8pt">
                ...
                <td colspan="3" style="border-bottom: solid black 1.0pt; border-right: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:TextBox ID="tb_ListeningStateOther" runat="server" TextMode="MultiLine"></asp:TextBox></span><span
                                lang="EN-US"><o:p></o:p></span></p>
                </td>
                <td colspan="2" style="width: 17.86%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    border-right: solid black 1.0pt; mso-border-top-alt: solid black .5pt; mso-border-left-alt: solid black .5pt;
                ...
                <td style="width: 13.28%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:TextBox ID="tb_ClassSetting" runat="server" TextMode="MultiLine"></asp:TextBox></span><span
                                lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 12; height: 23.5pt">
                ...
                <td colspan="9" style="width: 67.2%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:TextBox ID="tb_eat" runat="server" Width="420px"></asp:TextBox></span><span
                                lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 13; height: 22.9pt">
                ...
                <td colspan="9" style="width: 67.2%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:TextBox ID="tb_joke" runat="server" Width="420px"></asp:TextBox></span><span
                                lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 14; height: 22.9pt">
                ...
                <td colspan="9" style="width: 67.2%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:TextBox ID="tb_move" runat="server" Width="420px"></asp:TextBox></span><span
                                lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 15; height: 22.3pt">
                ...
                <td colspan="9" style="width: 67.2%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:TextBox ID="tb_sleep" runat="server" Width="420px"></asp:TextBox></span><span
                                lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 16; height: 22.3pt">
                ...
                <td colspan="9" style="width: 67.2%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:TextBox ID="tb_play" runat="server" Width="420px"></asp:TextBox></span><span
                                lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 17; height: 22.3pt">
                ...
                <td colspan="9" style="width: 67.2%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    width="67%">
                    <p class="MsoNormal">
                        <asp:TextBox ID="tb_ClassOrderOther" runat="server" Width="420px"></asp:TextBox>
                        <span lang="EN-US">
                            <o:p></o:p>
                        </span>
                    </p>
        ...
        <br />
        <asp:Button ID="btn_Add" CssClass="btn1" runat="server" Text="提交" OnClick="btn_Add_Click" />
        <p class="MsoNormal">
            &nbsp;</p>
    </div>
    </form>
