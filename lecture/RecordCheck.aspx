<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordCheck.aspx.cs" Inherits="lecture.RecordCheck" ValidateRequest="false" %>
...
<body>
    ...
    <div style="text-align: center">
        ...
        <table border="1" cellpadding="0" cellspacing="0" class="MsoNormalTable" width="100%">
            <tr style="mso-yfti-irow: 0; mso-yfti-firstrow: yes; height: 23.5pt">
                <td colspan="2" style="width: 18.02%; border: solid black 1.0pt; mso-border-alt: solid black .5pt;
                    ...
                    <p align="center" class="MsoNormal">
                        <span style="font-size: 9.0pt; line-height: 150%; font-family: 宋体; mso-ascii-font-family: Calibri;
                            mso-hansi-font-family: Calibri">周次</span></p>
                </td>
                <td style="width: 14.8%; border: solid black 1.0pt; border-left: none; mso-border-left-alt: solid black .5pt;
                    ...
                    <p align="center" class="MsoNormal">
                        <span lang="EN-US" style="font-size: 9.0pt; line-height: 150%">
                            <o:p></o:p>
                        <asp:Label ID="tb_WeekNumber" runat="server" ></asp:Label>
                        </span>
                    </p>
                </td>
                ...
                <td colspan="3" style="width: 14.82%; border: solid black 1.0pt; border-left: none;
                    ...
                    <p align="center" class="MsoNormal">
                        <span
                            ...
                            <asp:Label ID="tb_date" runat="server" Text="Label"></asp:Label>
                            </span>
                    </p>
                </td>
                <td colspan="3" style="width: 18.86%; border: solid black 1.0pt; border-left: none;
                    ...
                    <p align="center" class="MsoNormal">
                        <span style="font-size: 9.0pt; line-height: 150%; font-family: 宋体; mso-ascii-font-family: Calibri;
                            mso-hansi-font-family: Calibri">时间</span></p>
                </td>
                <td colspan="2" style="width: 20.48%; border: solid black 1.0pt; border-left: none;
                    ...
                    <p align="center" class="MsoNormal">
                        <span lang="EN-US" style="font-size: 9.0pt; line-height: 150%">
                            <o:p></o:p>
                            <asp:DropDownList ID="dd_time" runat="server" Enabled="False">
            ...
            <tr style="mso-yfti-irow: 1; height: 22.8pt">
                <td colspan="2" style="width: 18.02%; border: solid black 1.0pt; border-top: none;
                    ...
                    <p align="center" class="MsoNormal">
                        <span style="font-size: 9.0pt; line-height: 150%; font-family: 宋体; mso-ascii-font-family: Calibri;
                            mso-hansi-font-family: Calibri">地点</span><span lang="EN-US"><o:p></o:p></span></p>
                </td>
                <td style="width: 14.8%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p align="center" class="MsoNormal">
                        <span
                                lang="EN-US"><o:p></o:p>
                        <asp:Label ID="tb_place" runat="server"></asp:Label>
                        </span></p>
                </td>
                ...
                <td colspan="2" style="width: 20.48%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p align="center" class="MsoNormal">
                        <span
                                lang="EN-US"><o:p></o:p>
                        <asp:Label ID="tb_teacher" runat="server" ></asp:Label>
                        </span></p>
                </td>
            </tr>
                ...
                <td colspan="8" style="width: 54.16%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p align="center" class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                                ...
                                lang="EN-US"><o:p></o:p>
                        <asp:Label ID="tb_CourseName" runat="server"></asp:Label>
                        </span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 4; height: 22.8pt">
                ...
                <td colspan="9" style="width: 67.2%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p align="center" class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_late" runat="server"></asp:Label></span><span lang="EN-US"
            ...
            <tr style="mso-yfti-irow: 5; height: 22.8pt">
                ...
                <td colspan="9" style="width: 67.2%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p align="center" class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_LeaveEarly" runat="server"></asp:Label></span><span lang="EN-US"
                                style="font-size: 9.0pt; line-height: 150%"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 6; height: 22.8pt">
                ...
                <td style="width: 13.02%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p align="center" class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_CutSchool" runat="server"></asp:Label></span></p>
                </td>
                    ...
                    <p align="center" class="MsoNormal">
                        <span style="font-size: 9.0pt; line-height: 150%; font-family: 宋体; mso-ascii-font-family: Calibri;
                            mso-hansi-font-family: Calibri">应到</span><span lang="EN-US" style="font-size: 9.0pt;
                                line-height: 150%"><o:p></o:p></span><span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri"> 
                                    <asp:Label ID="tb_should" runat="server"></asp:Label></span></p>
                ...
                <td style="width: 13.28%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    width="13%">
                    <p align="center" class="MsoNormal">
                        <asp:Label ID="tb_real" runat="server"></asp:Label>
                        <span lang="EN-US"
                                style="font-size: 9.0pt; line-height: 150%"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 7; height: 22.8pt">
                ...
                <td colspan="3" style="border-bottom: solid black 1.0pt; border-right: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_interact" runat="server"></asp:Label></span><span lang="EN-US"><o:p></o:p></span></p>
                </td>
                ...
                <td style="width: 13.28%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_ClassHealth" runat="server"></asp:Label> </span>
            ...
            <tr style="mso-yfti-irow: 8; height: 22.8pt">
                ...
                <td colspan="3" style="border-bottom: solid black 1.0pt; border-right: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_AnswerTheQuestion" runat="server"></asp:Label></span><span
                ...
                <td style="width: 13.28%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        ...
                        <asp:Label ID="tb_ClassChair" runat="server"></asp:Label>
                        </span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 9; height: 22.8pt">
                ...
                <td colspan="3" style="border-bottom: solid black 1.0pt; border-right: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_ClassNote" runat="server"></asp:Label></span><span lang="EN-US"><o:p></o:p></span></p>
                </td>
                <td colspan="2" style="width: 17.86%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    border-right: solid black 1.0pt; mso-border-top-alt: solid black .5pt; mso-border-left-alt: solid black .5pt;
                    mso-border-alt: solid black .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 22.8pt"
                ...
                <td style="width: 13.28%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_projector" runat="server"></asp:Label></span><span lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 10; height: 22.8pt">
                ...
                <td colspan="3" style="border-bottom: solid black 1.0pt; border-right: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_books" runat="server"></asp:Label></span><span lang="EN-US"><o:p></o:p></span></p>
                </td>
                <td colspan="2" style="width: 17.86%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    border-right: solid black 1.0pt; mso-border-top-alt: solid black .5pt; mso-border-left-alt: solid black .5pt;
                    mso-border-alt: solid black .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 22.8pt"
                ...
                <td style="width: 13.28%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_sound" runat="server"></asp:Label></span><span lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 11; height: 22.8pt">
                ...
                <td colspan="3" style="border-bottom: solid black 1.0pt; border-right: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_ListeningStateOther" runat="server"></asp:Label></asp:TextBox></span><span
                                lang="EN-US"><o:p></o:p></span></p>
                </td>
                <td colspan="2" style="width: 17.86%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    border-right: solid black 1.0pt; mso-border-top-alt: solid black .5pt; mso-border-left-alt: solid black .5pt;
                ...
                <td style="width: 13.28%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_ClassSetting" runat="server"></asp:Label></span><span lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 12; height: 23.5pt">
                ...
                <td colspan="9" style="width: 67.2%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_eat" runat="server"></asp:Label></span><span lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 13; height: 22.9pt">
                ...
                <td colspan="9" style="width: 67.2%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_joke" runat="server"></asp:Label></span><span lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 14; height: 22.9pt">
                ...
                <td colspan="9" style="width: 67.2%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_move" runat="server"></asp:Label></span><span lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 15; height: 22.3pt">
                ...
                <td colspan="9" style="width: 67.2%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_sleep" runat="server"></asp:Label></span><span lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 16; height: 22.3pt">
                ...
                <td colspan="9" style="width: 67.2%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            <asp:Label ID="tb_play" runat="server"></asp:Label></span><span lang="EN-US"><o:p></o:p></span></p>
                </td>
            </tr>
            <tr style="mso-yfti-irow: 17; height: 22.3pt">
                ...
                <td colspan="9" style="width: 67.2%; border-top: none; border-left: none; border-bottom: solid black 1.0pt;
                    ...
                    width="67%">
                    <p class="MsoNormal">
                        <asp:Label ID="tb_ClassOrderOther" runat="server"></asp:Label>
                        <span lang="EN-US">
                            <o:p></o:p>
                        </span>
                    </p>
                    ...
                    <p class="MsoNormal">
                        <span style="font-size: 9.0pt; font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri">
                            其它情况：</span><span style="font-family: 宋体; mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri"><asp:TextBox
                                ID="tb_others" runat="server" Height="120px" TextMode="MultiLine" 
                            Width="90%" Enabled="False"></asp:TextBox></span><span
        ...
        <br />
&nbsp;<asp:Button ID="btn_update" CssClass="btn1" runat="server" Text="申请修改该条记录" 
            onclick="btn_update_Click" />
        &nbsp;
        <asp:Button ID="btn_go" CssClass="btn1" runat="server" Text="修改该条记录" onclick="btn_go_Click" />
        &nbsp;<asp:Button ID="btn_del" runat="server" Text="删除改条记录" CssClass="btn1"
            onclick="btn_del_Click" Visible="False" />
&nbsp;
        <asp:Button ID="btn_cancle" runat="server" Text="返回" CssClass="btn1"
