...
namespace lecture
{
    public partial class taskadd_new : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Session["User"] != null)
                {
                    ...
                    if (tea.UserType == "听课教师" || tea.UserType == "院级学生工作人员")
                    {
        ...
        protected void bt_add_Click(object sender, EventArgs e)
        {
            ...
            else if (dTime <= startWeek.AddDays(5))
            {
                lb_infotime.Text = "您的听课时间不能在本周及以前！";
                lb_infotime.ForeColor = System.Drawing.Color.Red;
            }
            else
            {
